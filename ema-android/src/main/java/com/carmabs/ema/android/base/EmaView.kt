...
interface EmaView<S: EmaBaseState, VM : EmaViewModel<S, NS>, NS : EmaNavigationState> {
    ...
    /**
     * Create the view model for the view and create 3 observers_
     *  - View state observer
     *  - Error observer
     *  - Navigation observer
     *
     * This observers handle the events generated by view updates/errors/navigation
     * @param fragment the scope of the view model
     */
    fun initializeViewModel(fragment: Fragment) {
        val vm = ViewModelProviders.of(fragment, EmaFactory(viewModelSeed))[viewModelSeed::class.java]
        vm.observableState.observe(fragment, Observer(this::onDataUpdated))
        vm.singleObservableState.observe(fragment, Observer(this::onSingleDataSent))
        vm.navigationState.observe(fragment, Observer(this::onNavigation))
    ...
    fun initializeViewModel(fragmentActivity: FragmentActivity, fragment: Fragment? = null) {
        val vm = ViewModelProviders.of(fragmentActivity, EmaFactory(viewModelSeed))[viewModelSeed::class.java]
