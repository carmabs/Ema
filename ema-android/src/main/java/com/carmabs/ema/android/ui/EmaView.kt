...
interface EmaView<S : EmaBaseState, VM : EmaViewModel<S, NS>, NS : EmaNavigationState> {
    ...
    fun initializeViewModel(fragmentActivity: FragmentActivity, fragment: Fragment? = null) {
        ...
        val resultViewModel =
            ViewModelProviders.of(fragmentActivity)[EmaResultViewModel::class.java]
     ...
     *
     * This observers handle the events generated by view updates/errors/navigation
     * @param lifeCycleOwner the lifeCycle owner of the viewmodel
     * @param viewModel the viewModel is going to be attached to state observers
     * @param resultViewModel viewModel to handle result between different views
     */
    ...
    fun onStartAndBindData(
        ...
        viewModel.navigationState.observe(lifeCycleOwner, Observer(this::onNavigation))

        resultViewModel?.also {
            it.resultEvent.observe(lifeCycleOwner, Observer(this::onResultSetHandled))
            it.resultReceiverEvent.observe(lifeCycleOwner, Observer(this::onResultReceivedHandled))
        }
    }
